  ...
  return (
    <div className="min-h-screen bg-background" data-module="attendance">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-4 space-y-4">
        ...
        {/* Tabs navigation */}
        <Tabs defaultValue="opa-suite" className="w-full">
          <TabsList className="grid w-full grid-cols-2 border border-border bg-muted/60 p-1 rounded-lg">
            <TabsTrigger value="opa-suite" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-md hover:bg-accent/60 transition-colors rounded-md font-medium">Opa Suite</TabsTrigger>
