Aqui está o conteúdo completo e final:

```typescript
// supabase/functions/fetch-opa-attendance/index.ts
...
async function opaFetch(path: string, params?: Record) {
